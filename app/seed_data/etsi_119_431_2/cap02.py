...
- Clausola 8.1 "Interface" (ASI-8.1-01..12): requisiti tecnici
  ...
  normalizzato a "ASI-8.1-04" per coerenza con gli id contigui e per la
...
- Clausola 9: il NOTE introduttivo (prima di OVR-9-01) definisce il concetto
  ...
  riferimento "9 (nota introduttiva)" (ADR-0007, disposizione di cornice con
  ...
  verso il Principio introduttivo "9 (nota introduttiva)" che ne definisce il
...
- Annex A (informativo, "Table of contents for SCASC practice statement"):
  ...
  aggregato, tipo "altro", riferimento "Annex A", che riassume la struttura e
...
- Annex C (informativo, "Mapping to advance electronic signatures or seals
  ...
  UN solo Principio aggregato, tipo "altro", riferimento "Annex C",
  ...
  questo stesso import), dove "OVR-6.2-05" è confermato come riferimento
  esatto — nodo_a risolto con `("obbligo", None, "OVR-6.2-05")`, che risolve
...
RIGHE_PRINCIPI = [
    {
        "riferimento": "9 (nota introduttiva)",
...
RELAZIONI: list[dict] = [
    {
        "nodo_da": ("obbligo", None, "OVR-7.6-02"),
        "nodo_a": ("obbligo", None, "OVR-7.6-01"),
        "tipo_relazione": "specifica",
        "evidence_type": "inferred",
        "confidence": None,
    },
    {
        "nodo_da": ("obbligo", None, "OVR-7.7-02"),
        "nodo_a": ("obbligo", None, "OVR-7.7-01"),
        "tipo_relazione": "specifica",
        "evidence_type": "inferred",
        "confidence": None,
    },
    {
        "nodo_da": ("obbligo", None, "OVR-7.7-03"),
        "nodo_a": ("obbligo", None, "OVR-7.7-01"),
        "tipo_relazione": "specifica",
        "evidence_type": "inferred",
        "confidence": None,
    ...
    {
        "nodo_da": ("obbligo", None, "OVR-7.7-04"),
        "nodo_a": ("obbligo", None, "OVR-7.7-01"),
        "tipo_relazione": "specifica",
        "evidence_type": "inferred",
        "confidence": None,
    },
    {
        ...
        "nodo_a": ("obbligo", None, "OVR-7.10-01"),
        "tipo_relazione": "specifica",
        "evidence_type": "inferred",
        "confidence": None,
    },
    ...
    {
        "nodo_da": ("obbligo", None, "OVR-7.10-06"),
        "nodo_a": ("obbligo", None, "OVR-7.10-01"),
        "tipo_relazione": "specifica",
        "evidence_type": "inferred",
        "confidence": None,
    },
    {
        ...
        "nodo_a": ("obbligo", None, "OVR-7.11-01"),
        "tipo_relazione": "specifica",
        "evidence_type": "inferred",
        "confidence": None,
    },
    {
        "nodo_da": ("obbligo", None, "OVR-7.11-03"),
        "nodo_a": ("obbligo", None, "OVR-7.11-01"),
        "tipo_relazione": "specifica",
        "evidence_type": "inferred",
        "confidence": None,
    },
    {
        ...
        "nodo_a": ("obbligo", None, "OVR-7.13-01"),
        "tipo_relazione": "specifica",
        "evidence_type": "inferred",
        "confidence": None,
    },
    ...
    {
        "nodo_da": ("obbligo", None, "OVR-7.13-04"),
        "nodo_a": ("obbligo", None, "OVR-7.13-01"),
        "tipo_relazione": "specifica",
        "evidence_type": "inferred",
        "confidence": None,
    ...
    {
        "nodo_da": ("obbligo", None, "OVR-7.10-05"),
        "nodo_a": ("obbligo", None, "OVR-7.10-01"),
        "tipo_relazione": "specifica",
    ...
    {
        "nodo_da": ("obbligo", None, "OVR-7.10-05"),
        "nodo_a": ("obbligo", None, "OVR-7.10-02"),
        "tipo_relazione": "specifica",
        "evidence_type": "textual",
        "confidence": None,
    },
    {
        "nodo_da": ("obbligo", None, "ASI-8.1-04"),
        "nodo_a": ("obbligo", None, "ASI-8.1-03"),
        "tipo_relazione": "specifica",
        "evidence_type": "inferred",
        "confidence": None,
    },
    {
        "nodo_da": ("obbligo", None, "ASI-8.1-05"),
        "nodo_a": ("obbligo", None, "ASI-8.1-03"),
        "tipo_relazione": "specifica",
        "evidence_type": "inferred",
        "confidence": None,
    ...
    {
        "nodo_da": ("obbligo", None, "ASI-8.1-06"),
        "nodo_a": ("obbligo", None, "ASI-8.1-03"),
        "tipo_relazione": "specifica",
        "evidence_type": "inferred",
        "confidence": None,
    ...
    {
        "nodo_da": ("obbligo", None, "ASI-8.1-08"),
        "nodo_a": ("obbligo", None, "ASI-8.1-03"),
        "tipo_relazione": "specifica",
        "evidence_type": "inferred",
        "confidence": None,
    ...
    {
        "nodo_da": ("obbligo", None, "ASI-8.1-09"),
        "nodo_a": ("obbligo", None, "ASI-8.1-03"),
        "tipo_relazione": "specifica",
        "evidence_type": "inferred",
        "confidence": None,
    ...
    {
        "nodo_da": ("obbligo", None, "ASI-8.1-10"),
        "nodo_a": ("obbligo", None, "ASI-8.1-03"),
        "tipo_relazione": "specifica",
        "evidence_type": "inferred",
        "confidence": None,
    ...
    {
        "nodo_da": ("obbligo", None, "ASI-8.1-11"),
        "nodo_a": ("obbligo", None, "ASI-8.1-03"),
        "tipo_relazione": "specifica",
        "evidence_type": "inferred",
        "confidence": None,
    ...
    {
        "nodo_da": ("obbligo", None, "ASI-8.1-12"),
        "nodo_a": ("obbligo", None, "ASI-8.1-03"),
        "tipo_relazione": "specifica",
        "evidence_type": "inferred",
        "confidence": None,
    ...
    {
        "nodo_da": ("obbligo", None, "OVR-8.2-09"),
        "nodo_a": ("obbligo", None, "OVR-8.2-08A"),
        "tipo_relazione": "specifica",
        "evidence_type": "textual",
        "confidence": None,
    },
    {
        "nodo_da": ("obbligo", None, "OVR-9-02"),
        "nodo_a": ("obbligo", None, "OVR-9-01A"),
        "tipo_relazione": "specifica",
        "evidence_type": "inferred",
        "confidence": None,
    },
    {
        "nodo_da": ("obbligo", None, "OVR-9-03"),
        "nodo_a": ("obbligo", None, "OVR-9-01A"),
        "tipo_relazione": "specifica",
        "evidence_type": "inferred",
        "confidence": None,
    ...
    {
        "nodo_da": ("obbligo", None, "OVR-9-01A"),
        "nodo_a": ("principio", None, "9 (nota introduttiva)"),
        "tipo_relazione": "specifica",
        "evidence_type": "inferred",
        "confidence": 0.7,
    },
    {
        "nodo_da": ("principio", None, "Annex C"),
        "nodo_a": ("obbligo", None, "OVR-B.1-01"),
    ...
    {
        "nodo_da": ("principio", None, "Annex C"),
        "nodo_a": ("obbligo", None, "OVR-B.1-02"),
        "tipo_relazione": "richiama",
        "evidence_type": "textual",
        "confidence": None,
    },
    {
        "nodo_da": ("principio", None, "Annex C"),
        "nodo_a": ("obbligo", None, "OVR-B.1-03"),
        "tipo_relazione": "richiama",
        "evidence_type": "textual",
        "confidence": None,
    },
    {
        "nodo_da": ("principio", None, "Annex C"),
        "nodo_a": ("obbligo", None, "OVR-8.2-02"),
        "tipo_relazione": "richiama",
        "evidence_type": "textual",
        "confidence": None,
    },
    {
        "nodo_da": ("principio", None, "Annex C"),
        "nodo_a": ("obbligo", None, "OVR-8.2-04"),
        "tipo_relazione": "richiama",
        "evidence_type": "textual",
        "confidence": None,
    },
    {
        "nodo_da": ("principio", None, "Annex C"),
        "nodo_a": ("obbligo", None, "OVR-6.2-05"),
        "tipo_relazione": "richiama",
        "evidence_type": "textual",
        "confidence": None,
    },
