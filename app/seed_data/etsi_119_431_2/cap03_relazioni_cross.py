...
RELAZIONI = [
    {
        'nodo_da': ('principio', 11, 'Parte 2: clausola 3.3 (Abbreviations)'),
        'nodo_a': ('principio', 11, 'Parte 1: clausola 3.3 (Abbreviations)'),
        'tipo_relazione': 'si sovrappone a',
        'evidence_type': 'inferred',
        'confidence': 0.6,
    },
    {
        'nodo_da': ('principio', 11, 'Parte 2: clausola 3.4 (Notations)'),
    ...
    {
        'nodo_da': ('principio', 11, 'Parte 2: clausola 4.1 (General policy requirements concepts)'),
        'nodo_a': ('principio', 11, 'Parte 1: clausola 4.1 (General policy requirements concepts)'),
        'tipo_relazione': 'si sovrappone a',
        'evidence_type': 'inferred',
        'confidence': 0.6,
    },
    {
        'nodo_da': ('principio', 11, 'Parte 2: clausola 4.2.1 (SCASC practice statement)'),
        'nodo_a': ('principio', 11, 'Parte 1: clausola 4.3.1 (SSAS practice statement)'),
        'tipo_relazione': 'si sovrappone a',
        'evidence_type': 'inferred',
        'confidence': 0.65,
    },
    {
        'nodo_da': ('principio', 11, 'Parte 2: clausola 4.2.2 (SCASC policy)'),
        'nodo_a': ('principio', 11, 'Parte 1: clausola 4.3.2 (SSAS policy)'),
        'tipo_relazione': 'si sovrappone a',
        'evidence_type': 'inferred',
        'confidence': 0.65,
    },
    {
        'nodo_da': ('principio', 11, 'Parte 2: clausola 4.2.3 (Terms and conditions)'),
        'nodo_a': ('principio', 11, 'Parte 1: clausola 4.3.3 (Terms and conditions)'),
        'tipo_relazione': 'si sovrappone a',
        'evidence_type': 'inferred',
        'confidence': 0.65,
    },
    {
        'nodo_da': ('principio', 11, 'Parte 2: clausola 4.3 (Architecture)'),
        'nodo_a': ('principio', 11, 'Parte 1: clausola 4.3.1 (SSAS practice statement)'),
    ...
    {
        'nodo_da': ('principio', 11, 'Parte 2: Annex C'),
    ...
    {
        'nodo_da': ('obbligo', 11, 'Parte 2: OVR-5-01'),
    ...
    {
        'nodo_da': ('obbligo', 11, 'Parte 2: OVR-6.1-01'),
        'nodo_a': ('obbligo', 11, 'Parte 1: OVR-6.8.4-01'),
        'tipo_relazione': 'si sovrappone a',
        'evidence_type': 'inferred',
        'confidence': 0.6,
    ...
    {
        'nodo_da': ('obbligo', 11, 'Parte 2: OVR-7.3-01'),
    ...
    {
        'nodo_da': ('obbligo', 11, 'Parte 2: OVR-7.5-01'),
    ...
    {
        'nodo_da': ('obbligo', 11, 'Parte 2: OVR-7.8-01'),
    ...
    {
        'nodo_da': ('obbligo', 11, 'Parte 2: OVR-7.11-02'),
    ...
    {
        'nodo_da': ('obbligo', 11, 'Parte 2: ASI-8.1-02'),
        'nodo_a': ('obbligo', 11, 'Parte 1: LNK-6.2.2-10A'),
        'tipo_relazione': 'si sovrappone a',
        'evidence_type': 'inferred',
        'confidence': 0.6,
    },
    {
        'nodo_da': ('obbligo', 11, 'Parte 2: OVR-8.2-01'),
    ...
    {
        'nodo_da': ('obbligo', 11, 'Parte 2: OVR-8.2-07'),
        'nodo_a': ('obbligo', 11, 'Parte 1: LNK-6.2.2-02C'),
        'tipo_relazione': 'si sovrappone a',
        'evidence_type': 'inferred',
        'confidence': 0.6,
    },
    {
        'nodo_da': ('obbligo', 11, 'Parte 2: OVR-8.2-08'),
        'nodo_a': ('obbligo', 11, 'Parte 1: SIG-A.6-07'),
        'tipo_relazione': 'si sovrappone a',
        'evidence_type': 'inferred',
        'confidence': 0.6,
    },
    {
        'nodo_da': ('obbligo', 11, 'Parte 2: OVR-9-03'),
    ...
    {
        'nodo_da': ('obbligo', 11, 'Parte 2: OVR-9-04'),
    ...
    {
        'nodo_da': ('obbligo', 11, 'Parte 2: OVR-9-05'),
    ...
    {
        'nodo_da': ('obbligo', 11, 'Parte 2: OVR-9-06'),
    ...
    {
        'nodo_da': ('obbligo', 11, 'Parte 2: OVR-9-06'),
        'nodo_a': ('obbligo', 11, 'Parte 1: OVR-7-07'),
        'tipo_relazione': 'si sovrappone a',
        'evidence_type': 'inferred',
        'confidence': 0.6,
    },
    {
        'nodo_da': ('obbligo', 11, 'Parte 2: OVR-9-07'),
        'nodo_a': ('obbligo', 11, 'Parte 1: OVR-7-07'),
        'tipo_relazione': 'si sovrappone a',
        'evidence_type': 'inferred',
        'confidence': 0.6,
    ...
    {
        'nodo_da': ('obbligo', 11, 'Parte 2: OVR-9-08'),
        'nodo_a': ('obbligo', 11, 'Parte 1: OVR-7-08'),
        'tipo_relazione': 'si sovrappone a',
        'evidence_type': 'inferred',
        'confidence': 0.65,
    },
    {
        'nodo_da': ('obbligo', 11, 'Parte 2: OVR-9-08'),
        'nodo_a': ('obbligo', 11, 'Parte 1: OVR-7-09'),
        'tipo_relazione': 'si sovrappone a',
        'evidence_type': 'inferred',
        'confidence': 0.6,
    },
    {
        'nodo_da': ('obbligo', 11, 'Parte 2: OVR-9-09'),
        'nodo_a': ('obbligo', 11, 'Parte 1: OVR-7-09'),
        'tipo_relazione': 'si sovrappone a',
        'evidence_type': 'inferred',
        'confidence': 0.6,
    ...
    {
        'nodo_da': ('obbligo', 11, 'Parte 2: OVR-9-10'),
        'nodo_a': ('obbligo', 11, 'Parte 1: OVR-7-10'),
        'tipo_relazione': 'si sovrappone a',
        'evidence_type': 'inferred',
        'confidence': 0.6,
    },
